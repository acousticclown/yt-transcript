 ...
 * Clean vector icons for the design system
 */
...
export function NotesIcon({ className = "w-5 h-5", size }: IconProps) {
  const style = size ? { width: size, height: size } : undefined;
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function TagIcon({ className = "w-5 h-5", size }: IconProps) {
  const style = size ? { width: size, height: size } : undefined;
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function PenIcon({ className = "w-5 h-5", size }: IconProps) {
  const style = size ? { width: size, height: size } : undefined;
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function FolderIcon({ className = "w-5 h-5", size }: IconProps) {
  const style = size ? { width: size, height: size } : undefined;
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function ExportIcon({ className = "w-5 h-5", size }: IconProps) {
  const style = size ? { width: size, height: size } : undefined;
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function CloseIcon({ className = "w-5 h-5", size }: IconProps) {
  const style = size ? { width: size, height: size } : undefined;
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function ShareIcon({ className = "w-5 h-5", size }: IconProps) {
  const style = size ? { width: size, height: size } : undefined;
  return (
    <svg className={className} style={style} fill="none" stroke="currentColor" viewBox="0 0 24 24">
